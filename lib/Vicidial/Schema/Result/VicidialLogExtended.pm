use utf8;
package Vicidial::Schema::Result::VicidialLogExtended;
...
Vicidial::Schema::Result::VicidialLogExtended
...
=head1 TABLE: C<vicidial_log_extended>

=cut

__PACKAGE__->table("vicidial_log_extended");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ae4iz8vZeqgxPWBjIUZbNQ
