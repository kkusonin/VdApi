use utf8;
package Vicidial::Schema::Result::VicidialLogArchive;
...
Vicidial::Schema::Result::VicidialLogArchive
...
=head1 TABLE: C<vicidial_log_archive>

=cut

__PACKAGE__->table("vicidial_log_archive");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7HH0UQAv/vJUSVAy6sZu0A
