use utf8;
package Vicidial::Schema::Result::TwodayVicidialLog;
...
Vicidial::Schema::Result::TwodayVicidialLog
...
=head1 TABLE: C<twoday_vicidial_log>

=cut

__PACKAGE__->table("twoday_vicidial_log");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tfAdgWpb8XaMfwryM70OGA
