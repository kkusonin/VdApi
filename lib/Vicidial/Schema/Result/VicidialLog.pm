use utf8;
package Vicidial::Schema::Result::VicidialLog;
...
Vicidial::Schema::Result::VicidialLog
...
=head1 TABLE: C<vicidial_log>

=cut

__PACKAGE__->table("vicidial_log");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:e37RlqKDyRU8QOqUidIm7g
